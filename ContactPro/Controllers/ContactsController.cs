...
using static ContactPro.Enums.States;
using static ContactPro.Enums.Roles;
...
namespace ContactPro.Controllers
{
    public class ContactsController : Controller
    {
        ...
        public IActionResult Index(int categoryId, string swalMessage = null)
        {
            ...
            //var applicationDbContext = _context.Contacts.Include(c => c.AppUser); original line
        ...
        public async Task<IActionResult> Create()
        {
            ...
            //ViewData["RoleList"] = new SelectList(Enum.GetValues(typeof(UserRoles)).Cast<UserRoles>().ToList());
            return View();
        }
